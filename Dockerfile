...
# to run a container on this image, run "docker run --privileged --network="host" <IMAGE_ID>" you can get the IMAGE_ID by running "docker images" (NOTE: you may have to start the container with the --network="host")
